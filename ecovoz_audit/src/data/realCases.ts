...
export const publicEvidenceCases: RealCase[] = [
  ...
  },
  {
    ...
    sourceType: 'official',
    label: 'Dado oficial',
    imageUrl: 'https://images.unsplash.com/photo-1581094288338-2314dddb7ece?auto=format&fit=crop&q=80&w=900',
  ...
  },
  {
    ...
    sourceType: 'official',
    label: 'Dado oficial',
    imageUrl: 'https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&q=80&w=900',
  ...
  },
  {
    ...
    sourceType: 'official',
    label: 'Dado oficial',
    imageUrl: 'https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&q=80&w=900',
