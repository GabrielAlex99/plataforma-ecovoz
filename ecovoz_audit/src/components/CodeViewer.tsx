...
<body class="bg-[#071613] text-[#f3f4f6]">
    ...
    <header class="fixed top-0 left-0 right-0 bg-[#0f2a24]/95 border-b border-[#1b3d35] z-50 py-4 px-6">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <button type="button" id="btn-mobile" class="md:hidden text-white">☰</button>
        </div>
    </header>
    ...
    <section id="mapa" class="py-20 px-6 bg-[#0b1c19] border-t border-emerald-950">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-wrap gap-2 mb-6" id="map-filters">
                <button type="button" class="filter-btn bg-emerald-500 text-black px-4 py-2 rounded-xl text-sm font-bold" data-cat="Todos">Todos</button>
                <button type="button" class="filter-btn bg-emerald-950 text-emerald-300 px-4 py-2 rounded-xl text-sm" data-cat="Ar">Ar</button>
                <button type="button" class="filter-btn bg-emerald-950 text-emerald-300 px-4 py-2 rounded-xl text-sm" data-cat="Água">Água</button>
                <button type="button" class="filter-btn bg-emerald-950 text-emerald-300 px-4 py-2 rounded-xl text-sm" data-cat="Ruído">Ruído</button>
                <button type="button" class="filter-btn bg-emerald-950 text-emerald-300 px-4 py-2 rounded-xl text-sm" data-cat="Verde urbano">Verde Urbano</button>
            </div>
