      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-[#e9ecef] rounded-3xl p-6 md:p-8 shadow-xs mb-10 text-left flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-5">
            <div className="bg-[#1b4332] text-white p-[18px] rounded-full shadow-md">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-[#DDE8D8] mb-8 gap-4">
        ...
        {activeTab === 'relatos' ? (
          ...
          <div className="space-y-4 text-left">
            {userRelatos.length > 0 ? (
              userRelatos.map((r) => (
                <div key={r.id} className="bg-white border border-[#e9ecef] rounded-3xl p-6 shadow-xs relative hover:border-[#1b4332]/25 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div className="space-y-3 max-w-full md:max-w-[70%]">
                    ...
                    <div className="flex items-center space-x-2.5">
                      ...
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md border ${
                        r.gravidade === 'Crítica' ? 'bg-rose-50 text-rose-600 border-rose-200' :
                    ...
                    <p className="text-[#4B5F55] text-xs sm:text-sm leading-relaxed">{r.descricao}</p>
          ...
          <div className="space-y-4 text-left">
            {userPropostas.length > 0 ? (
              userPropostas.map((p) => (
                <div key={p.id} className="bg-white border border-[#e9ecef] rounded-3xl p-6 shadow-xs relative hover:border-[#1b4332]/25 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div className="space-y-3 max-w-full md:max-w-[70%]">
                    ...
                    <p className="text-[#4B5F55] text-xs sm:text-sm leading-relaxed">{p.descricao}</p>

                    {/* Impact subcard */}
                    <div className="bg-[#f5f7f6] p-3 rounded-xl border border-[#DDE8D8] text-xs text-left">
                      <strong className="text-[#1b4332] block mb-0.5">Impacto Mitigatório Estimado:</strong>
                      <span className="text-[#4B5F55] font-normal">{p.impacto}</span>
                    </div>

                    {/* Progress tracking quick updating bar */}
                    <div className="flex items-center space-x-2.5 bg-gray-50 border border-[#DDE8D8] rounded-xl p-2.5 max-w-xs cursor-pointer shadow-3xs mt-1 text-left">
