                  ...
                  <button type="button"
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                      selectedCategory === cat
                        ...
                        : 'bg-white border border-[#A8CBB1]/40 text-[#4B5F55] hover:bg-gray-50'
                    }`}
                  >
                    {cat}
                  </button>
          ...
          {filteredSolucoes.length > 0 ? (
            filteredSolucoes.map((s) => {
              ...
              return (
                <div 
                  key={s.id} 
                  className={`bg-white border rounded-3xl p-6 shadow-xs relative flex flex-col justify-between hover:border-[#123524] transition-all duration-300 group hover:-translate-y-1 hover:shadow-md ${
                ...
                >
                  <div className="space-y-4">
                    ...
                    {/* Short Description */}
                    <p className="text-[#4B5F55] text-xs leading-relaxed font-light line-clamp-3">
                      {s.description}
                    </p>
                  ...
                  <div className="pt-4 mt-4 border-t border-gray-100 flex justify-between items-center bg-white">
                    <span className="text-[9px] font-mono text-gray-400 uppercase font-black tracking-widest">Complexidade: <span className="text-[#4B5F55]">{s.complexity}</span></span>
                    <button type="button"
          ...
          <div className="fixed inset-0 z-55 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 text-left">
            <div className="bg-white border border-[#A8CBB1] rounded-[28px] max-w-2xl w-full p-6 md:p-8 shadow-2xl relative max-h-[90vh] overflow-y-auto custom-scrollbar">
              ...
              <button type="button" 
                ...
                className="absolute top-4 right-4 p-2 rounded-xl bg-gray-50 text-gray-400 hover:text-gray-700 border border-[#DDE8D8] cursor-pointer"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-[#F4F7F2] p-4 rounded-xl border border-[#A8CBB1]/20 text-xs">
                    ...
                    <p className="text-[#4B5F55] leading-relaxed font-medium">{activeModalSol.expectedImpact}</p>
                  </div>
                ...
                <div className="text-[11px] text-[#4B5F55] flex items-start space-x-2 bg-gray-50 p-3 rounded-xl border border-[#DDE8D8]">
