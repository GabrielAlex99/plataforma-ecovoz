        ...
        <div className="bg-white border border-[#e9ecef] rounded-3xl p-6 md:p-10 shadow-lg relative">
          ...
          {submitted ? (
            ...
            <div className="py-12 px-4 text-center space-y-6 animate-fade-in text-left">
              ...
              <h3 className="font-sans font-bold text-2xl sm:text-3xl text-[#1b4332]">Solução cadastrada com sucesso!</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-[#1b4332]/5 border border-[#1b4332]/20 p-4 rounded-2xl flex items-start space-x-3.5 text-left">
                ...
                <p className="text-xs text-[#4B5F55] leading-relaxed">
              ...
              {errorMess && (
                <div className="bg-rose-50 border border-rose-200 p-4 rounded-xl text-xs text-rose-700 flex items-center space-x-2 text-left animate-pulse">
                  <span>{errorMess}</span>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white border border-[#e9ecef] text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#1b4332] text-sm transition-colors font-semibold shadow-xs"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left font-normal">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white border border-[#e9ecef] text-[#0b3d59] focus:outline-none focus:border-[#1b4332] text-sm transition-colors shadow-xs font-medium"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white border border-[#e9ecef] rounded-xl text-gray-800 text-xs focus:outline-none focus:border-[#1b4332] shadow-xs font-medium"
                  >
              ...
              {/* LGPD Clause */}
              <div className="bg-[#1b4332]/5 border border-[#1b4332]/10 rounded-2xl p-[18px] text-left text-xs text-[#4B5F55] space-y-3 shadow-xs font-normal">
                <div className="flex items-start space-x-2.5">
                  ...
                  />
                  <label htmlFor="checkbox-lgpd-proposta" className="leading-relaxed select-none cursor-pointer text-[#4B5F55]">
