...
export const galeriaDeImpactos: GalleryItem[] = [
  {
    ...
    imagemUrl: 'https://images.unsplash.com/photo-1508962914676-134849a727f0?auto=format&fit=crop&q=80&w=600',
    categoria: 'Ar',
  ...
  },
  {
    ...
    imagemUrl: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=600',
    categoria: 'Água',
  ...
  },
  {
    ...
    imagemUrl: 'https://images.unsplash.com/photo-1532187863486-abf9d39d66e8?auto=format&fit=crop&q=80&w=600',
    categoria: 'Resíduos',
  ...
  },
  {
    ...
    imagemUrl: 'https://images.unsplash.com/photo-1547683905-f686c993aae5?auto=format&fit=crop&q=80&w=600',
  ...
  },
  {
    ...
    imagemUrl: 'https://images.unsplash.com/photo-1516937941344-00b4e0337589?auto=format&fit=crop&q=80&w=600',
  ...
  },
  {
    ...
    imagemUrl: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&q=80&w=600',
    categoria: 'Verde urbano',
...
export default function ImpactMap({ relatos }: ImpactMapProps) {
  ...
  useEffect(() => {
    ...
    const handleGalleryEscape = (event: KeyboardEvent) => {
    ...
    <section id="mapa" className="py-20 bg-[#F4F7F2] border-t border-[#A8CBB1]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex flex-wrap gap-1.5 bg-white p-2 rounded-3xl border border-[#e9ecef] shadow-2xs flex-1 text-left">
            {categories.map((cat) => (
              <button type="button"
                key={cat}
                onClick={() => {
                ...
                className={`px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-200 ${
                  selectedCategory === cat
                    ...
                    : 'text-[#4B5F55] hover:bg-gray-50 hover:text-[#1b4332]'
                }`}
              >
                {cat}
              </button>
          ...
          <button type="button"
            ...
            className={`px-5 py-3 rounded-2xl text-xs sm:text-sm font-bold flex items-center justify-center gap-2 border transition-all cursor-pointer shadow-xs whitespace-nowrap ${
              heatmapMode
                ...
                : 'bg-white border-[#e9ecef] text-[#4B5F55] hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200'
            }`}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 bg-white border border-[#e9ecef] rounded-3xl p-4 flex flex-col justify-between shadow-md relative min-h-[480px] overflow-hidden">
                ...
                {activePopupRelato && (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pb-1 text-[9.5px] border-b border-[#DDE8D8] mb-2 gap-x-2">
                      ...
                      <button type="button" onClick={() => setActivePopupRelato(null)} className="text-[#4B5F55] hover:text-[#16231C] cursor-pointer">
                        <X className="h-4 w-4" />
                      </button>
                    </div>
            ...
            {/* Map legends */}
            <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 items-center justify-between text-[11px] text-gray-500 font-semibold px-1 border-t border-[#DDE8D8] pt-3">
              {heatmapMode ? (
                <div className="flex items-center space-x-2">
                  <span className="text-rose-600 font-bold uppercase text-[9px]">Gravidade de Acordo com Densidade:</span>
                  <div className="w-24 h-2 rounded-full bg-gradient-to-r from-yellow-200 via-orange-400 to-rose-600 border border-[#DDE8D8]" />
          ...
          <div className="lg:col-span-4 flex flex-col space-y-4 text-left">
              ...
              {industrySearchResults && (
                <div className="pt-2 max-h-[140px] overflow-y-auto custom-scrollbar space-y-2 border-t border-gray-100">
                  {industrySearchResults.length > 0 ? (
                    ...
                    <div className="p-3 text-center text-[11px] text-gray-400 bg-gray-50 border border-[#DDE8D8] rounded-xl">
            ...
            <div className="bg-white border border-[#e9ecef] rounded-3xl p-5 shadow-sm flex flex-col flex-grow">
              ...
              {reviewAverages && (
                <div className="grid grid-cols-3 gap-2 p-2 bg-[#f5f7f6] rounded-xl border border-[#DDE8D8] mb-3 text-center text-[10px]">
                  <div>
              ...
              <div className="space-y-2.5 overflow-y-auto max-h-[175px] pr-1 flex-grow custom-scrollbar text-left font-sans">
                {filteredReviews.length > 0 ? (
                  filteredReviews.map((rev) => (
                    <div key={rev.id} className="p-3 bg-white border border-[#DDE8D8] rounded-xl space-y-1.5 text-xs shadow-3xs animate-fade-in relative">
                      <div className="flex items-center justify-between">
                      ...
                      <p className="text-[#4B5F55] text-[10.5px] leading-relaxed italic font-normal">
                        "{rev.depoimento}"
                      </p>
                  ...
                  <div className="py-6 text-center text-[11px] text-gray-400 border border-dashed border-[#DDE8D8] rounded-xl">
        ...
        <div className="mt-16 pt-16 border-t border-[#A8CBB1]/30 text-left">
          <div className="mb-8">
            ...
            <p className="text-[#4B5F55] text-xs sm:text-sm max-w-xl mt-1">
              Registros visuais demonstrativos para apresentar como a plataforma poderia organizar fotos, status e encaminhamentos dos relatos comunitários.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <button type="button" aria-label={`Abrir detalhes do registro: ${item.titulo}`} className="relative h-44 w-full overflow-hidden bg-[#E8F1EA] ecovoz-image-fallback cursor-pointer text-left" onClick={() => setSelectedGalleryItem(item)}>
                      <img
                        src={item.imagemUrl}
                        alt={item.titulo}
        ...
        {selectedGalleryItem && (
          <div className="fixed inset-0 z-55 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4" onMouseDown={(event) => { if (event.target === event.currentTarget) setSelectedGalleryItem(null); }}>
            <div role="dialog" aria-modal="true" aria-labelledby="gallery-modal-title" className="bg-white border border-[#DDE8D8] rounded-3xl max-w-2xl w-full overflow-hidden shadow-sm relative text-left animate-scale-up max-h-[90vh] flex flex-col text-[#16231C]">
              ...
              <div className="overflow-y-auto custom-scrollbar flex-grow">
                ...
                <div className="relative h-64 sm:h-72 bg-gray-900">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-left ecovoz-media-overlay">
                    ...
                    <h3 id="gallery-modal-title" className="font-sans font-black text-xl sm:text-2xl tracking-tight leading-snug text-white">
