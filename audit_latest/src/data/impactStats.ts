...
export const realImpactStats: ImpactStat[] = [
  ...
  },
  {
    ...
    description: 'O SEEG disponibiliza estimativas anuais de emissões de gases de efeito estufa por setor e território, permitindo relacionar pressões produtivas, metas climáticas e planejamento de mitigação.',
