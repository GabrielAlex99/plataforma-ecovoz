...
export default function Header({
  ...
  const navItems = [
    ...
    { id: 'dores', label: 'Impactos no Território 💔', shortLabel: 'Impactos', desc: 'Dados oficiais, casos documentados e impacto humano', icon: Heart },
            ...
            >
              ...
              <div className="relative ml-2">
                <button
                  ...
                  className="flex h-8 w-[156px] items-center justify-between gap-1.5 rounded-lg border border-[#DDE8D8] bg-[#F8FAF7] px-2.5 text-[12px] font-extrabold text-[#123524] shadow-sm transition hover:border-[#F28C28] hover:bg-white"
                ...
                {dropdownOpen && (
                  <div className="absolute left-0 z-50 mt-2 max-h-[380px] w-[360px] overflow-y-auto rounded-2xl border border-[#DDE8D8] bg-white py-2 shadow-2xl animate-fade-in">
