      ...
      <section className="relative z-10 pt-24 pb-16 md:pt-32 md:pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <div className="inline-flex items-center space-x-2 bg-white border border-[#A8CBB1] px-4 py-1.5 rounded-full shadow-sm">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <button
                ...
                className="px-6 py-3.5 bg-white hover:bg-gray-50 text-[#123524] font-extrabold rounded-xl flex items-center justify-center space-x-2 border border-[#A8CBB1] transition-all shadow-sm active:scale-98 cursor-pointer text-xs uppercase tracking-wider [&_span]:text-[#123524]"
              >
          ...
          <div className="lg:col-span-6">
            <div className="bg-white border border-[#A8CBB1] rounded-3xl p-6 shadow-md text-left space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-5">
                ...
                <div className="sm:col-span-7 bg-[#F4F7F2] border border-[#A8CBB1]/40 rounded-2xl p-3 h-36 flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="absolute top-10 left-16 w-3 h-3 rounded-full bg-[#F28C28] border border-white animate-pulse shadow-sm"></div>
                  <div className="absolute bottom-8 right-12 w-3 h-3 rounded-full bg-[#2F6B4F] border border-white shadow-sm"></div>
                  
                  <span className="text-[9px] font-extrabold uppercase tracking-wider text-[#123524] bg-white px-2 py-0.5 rounded border border-[#A8CBB1]/40 shadow-sm inline-block w-fit z-10">
      ...
      <section className="relative z-10 py-16 md:py-24 bg-white border-t border-[#A8CBB1]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div 
              onClick={() => handleAction('relatar')}
              className="bg-white border border-[#A8CBB1]/65 rounded-3xl p-7 text-left space-y-4 shadow-sm hover:shadow-md hover:border-[#123524] transition-all cursor-pointer group flex flex-col justify-between h-56"
            >
          ...
          <div className="bg-[#FFFFFF] border border-[#A8CBB1]/50 p-8 rounded-3xl text-left max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sm">
