...
export default function AccessibilityMenu({
  ...
  return (
    <>
      ...
      {isOpen && (
        <div 
          className="fixed inset-y-0 right-0 z-55 w-80 md:w-96 bg-white shadow-2.5xl border-l border-gray-200 p-6 flex flex-col overflow-y-auto animate-fade-in text-left transition-all"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div className="space-y-6 mt-6 flex-1">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-[#f5f7f6] p-2 rounded-xl flex items-center justify-between border border-gray-200">
                ...
                <div className="flex items-center space-x-1">
                  <button
                    ...
                    className="p-1.5 bg-white text-gray-700 rounded-lg hover:bg-gray-100 border border-gray-200 transition disabled:opacity-40"
                  ...
                  <button
                    ...
                    className="p-1.5 bg-white text-gray-700 rounded-lg hover:bg-gray-100 border border-gray-200 transition"
            ...
            <div className="bg-[#f5f7f6] p-5 rounded-2xl border border-gray-200 space-y-3">
              <button
                ...
                <div className="space-y-2.5 pt-2 border-t border-gray-200 animate-fade-in text-xs max-h-48 overflow-y-auto custom-scrollbar">
                  {shortcuts.map((sc) => (
                    <div key={sc.key} className="flex justify-between items-start gap-1 pb-1.5 border-b border-gray-100 last:border-0">
                      <kbd className="px-1.5 py-0.5 bg-white border border-gray-300 rounded shadow-sm text-[9.5px] font-mono text-gray-800 shrink-0 font-bold">
                        {sc.key}
                      </kbd>
