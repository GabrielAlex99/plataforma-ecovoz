...
export const galeriaDeImpactos: GalleryItem[] = [
  {
    id: 'gal-1',
    titulo: 'Dispersão Severa de Particulados',
    imagemUrl: '/images/gallery-air.svg',
    categoria: 'Ar',
    localizacao: 'Santa Cruz (Jesuítas), RJ',
    data: 'Demonstração',
    status: 'Em Análise',
    descricao: 'Dispersão de poeira e fuligem industrial sobre o perímetro residencial de Jesuítas, cobrindo plantações e gerando reações asmáticas frequentes em crianças.',
    autor: 'Registro demonstrativo do protótipo'
  },
  {
    id: 'gal-2',
    titulo: 'Vazamentos Perigosos Periféricos',
    imagemUrl: '/images/gallery-water.svg',
    categoria: 'Água',
    localizacao: 'Santa Cruz dos Navegantes, SP',
    data: 'Demonstração',
    status: 'Vistoriado',
    descricao: 'Presença recorrente de óleos combustíveis brilhantes em canais estuarinos adjacentes às cooperativas de pescadores locais artesanais.',
    autor: 'Registro demonstrativo do protótipo'
  },
  {
    id: 'gal-3',
    titulo: 'Resíduos Tóxicos Clorados',
    imagemUrl: '/images/gallery-waste.svg',
    categoria: 'Resíduos',
    localizacao: 'Cubatão (Vila Parisi), SP',
    data: 'Demonstração',
    status: 'Ação Planejada',
    descricao: 'Tambores oxidados abandonados clandestinamente contendo substâncias oleosas sem nenhuma barreira física ou impermeabilização no solo.',
    autor: 'Registro demonstrativo do protótipo'
  },
  {
    id: 'gal-4',
    titulo: 'Alagamentos em Dias de Alta Maré',
    imagemUrl: '/images/gallery-flood.svg',
    categoria: 'Mobilidade',
    localizacao: 'Cubatão, SP',
    data: 'Demonstração',
    status: 'Resolvido',
    descricao: 'Ausência de galerias pluviais adequadas faz com que a maré alta represe os efluentes pluviais, inundando residências com lama preta.',
    autor: 'Registro demonstrativo do protótipo'
  },
  {
    id: 'gal-5',
    titulo: 'Desmatamento Perimetral Crítico',
    imagemUrl: '/images/gallery-green.svg',
    categoria: 'Verde urbano',
    localizacao: 'Pirajá, Salvador - BA',
    data: 'Demonstração',
    status: 'Em Análise',
    descricao: 'Arruamento inadequado e derrubada de remanescentes florestais para instalação de pátios industriais sem licença de impacto social.',
    autor: 'Registro demonstrativo do protótipo'
  },
  {
    id: 'gal-6',
    titulo: 'Recomposição Arbórea Eficaz',
    imagemUrl: '/images/gallery-solution.svg',
    categoria: 'Verde urbano',
    localizacao: 'Perimetral Norte, RS',
    data: 'Demonstração',
    status: 'Resolvido',
    descricao: 'Intervenção coletiva popular plantando centenas de mudas nativas para atuar como mitigador de barulho e zona tampão ambiental.',
    autor: 'Registro demonstrativo do protótipo'
  }
];
  ...
  return (
    <section id="mapa" className="py-20 bg-[#F4F7F2] border-t border-[#A8CBB1]/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white border border-[#e9ecef] rounded-3xl p-6 mb-8 text-left grid grid-cols-1 md:grid-cols-12 gap-5 shadow-sm relative z-40">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div className="flex flex-wrap gap-1.5 bg-white p-2 rounded-3xl border border-[#e9ecef] shadow-sm flex-1 text-left">
            {categories.map((cat) => (
              <button
                key={cat}
                onClick={() => {
                ...
                className={`px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-200 ${
                  selectedCategory === cat
                    ? 'bg-[#0b3d59] text-white font-bold shadow-sm'
          ...
          <button
            ...
            className={`px-5 py-3 rounded-2xl text-xs sm:text-sm font-bold flex items-center justify-center gap-2 border transition-all cursor-pointer shadow-sm whitespace-nowrap ${
              heatmapMode
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 bg-white border border-[#e9ecef] rounded-3xl p-4 flex flex-col justify-between shadow-md relative min-h-[480px] overflow-hidden">
            ...
            <div className="absolute top-4 left-4 z-10 flex flex-col gap-1 text-left">
              <div className="flex items-center space-x-2 bg-white/95 backdrop-blur-xs px-3.5 py-1.5 rounded-xl border border-[#e9ecef] shadow-sm">
              ...
              <div className="bg-[#1b4332] text-[9px] font-mono text-white/95 px-2 py-0.5 rounded-md border border-[#235841] shadow-sm self-start tracking-wider uppercase">
            ...
            {hoverCoordinates && (
              <div className="absolute bottom-4 left-4 z-10 bg-white/90 backdrop-blur-xs border border-[#e9ecef] px-2.5 py-1 rounded-lg text-[9px] font-mono text-gray-500 shadow-sm">
            ...
            <div className="absolute top-4 right-4 z-10 flex flex-col space-y-1">
              <button 
                ...
                className="w-8 h-8 bg-white hover:bg-gray-50 text-[#1b4332] border border-[#e9ecef] rounded-lg shadow-sm flex items-center justify-center font-bold transition-colors focus:outline-none"
                title="Ampliar"
              >
            ...
            <div className="w-full h-full relative border border-gray-100 rounded-3xl bg-gradient-to-br from-[#ecf3f0] to-[#dbeef9] flex items-center justify-center p-2 pt-16 min-h-[380px] overflow-hidden select-none">
            ...
            {/* Map legends */}
            <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 items-center justify-between text-[11px] text-gray-500 font-semibold px-1 border-t border-gray-200 pt-3">
              {heatmapMode ? (
                <div className="flex items-center space-x-2">
                  <span className="text-rose-600 font-bold uppercase text-[9px]">Gravidade de Acordo com Densidade:</span>
                  <div className="w-24 h-2 rounded-full bg-gradient-to-r from-yellow-200 via-orange-400 to-rose-600 border border-gray-200" />
                  <span className="text-[10px] font-normal">Concentrações de Ruído / Fuligem</span>
                </div>
              ) : (
                <div className="flex items-center space-x-2.5">
                  <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-full bg-rose-500 mr-1.5 inline-block border border-white shadow-sm"></span> Crítica</span>
                  <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-full bg-[#f28f3b] mr-1.5 inline-block border border-white shadow-sm"></span> Alta</span>
                  <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-full bg-yellow-500 mr-1.5 inline-block border border-white shadow-sm"></span> Média</span>
                  <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-full bg-[#1b4332] mr-1.5 inline-block border border-white shadow-sm"></span> Baixa</span>
                </div>
              )}
          ...
          <div className="lg:col-span-4 flex flex-col space-y-4 text-left">
            ...
            <div className="bg-[#f28f3b]/10 border border-[#f28f3b]/20 rounded-3xl p-5 shadow-sm text-left">
            ...
            <div className="bg-white border border-[#e9ecef] rounded-3xl p-5 shadow-sm space-y-4">
              ...
              <button
                ...
                className="w-full py-2.5 bg-[#0b3d59] hover:bg-[#072a42] text-white font-bold text-xs rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer shadow-sm disabled:opacity-50 disabled:cursor-wait"
              >
              ...
              {industrySearchResults && (
                <div className="pt-2 max-h-[140px] overflow-y-auto custom-scrollbar space-y-2 border-t border-gray-100">
                  {industrySearchResults.length > 0 ? (
                    ...
                    <div className="p-3 text-center text-[11px] text-gray-400 bg-gray-50 border border-gray-200 rounded-xl">
            ...
            <div className="bg-white border border-[#e9ecef] rounded-3xl p-5 shadow-sm flex flex-col flex-grow">
              ...
              {reviewAverages && (
                <div className="grid grid-cols-3 gap-2 p-2 bg-[#f5f7f6] rounded-xl border border-gray-200 mb-3 text-center text-[10px]">
                  <div>
                    <span className="text-gray-400 block text-[8px] uppercase font-bold">Qualidade do Ar</span>
                    <strong className="text-[#2d3436] font-extrabold">{reviewAverages.ar} / 5.0</strong>
                  </div>
                  <div>
                    <span className="text-gray-400 block text-[8px] uppercase font-bold">Conforto Acústico</span>
                    <strong className="text-[#2d3436] font-extrabold">{reviewAverages.som} / 5.0</strong>
                  </div>
                  <div>
                    <span className="text-gray-400 block text-[8px] uppercase font-bold">Bem-Estar Geral</span>
              ...
              <div className="space-y-2.5 overflow-y-auto max-h-[175px] pr-1 flex-grow custom-scrollbar text-left font-sans">
                {filteredReviews.length > 0 ? (
                  filteredReviews.map((rev) => (
                    <div key={rev.id} className="p-3 bg-white border border-gray-200 rounded-xl space-y-1.5 text-xs shadow-sm animate-fade-in relative">
                      <div className="flex items-center justify-between">
                      ...
                      <p className="text-gray-600 text-[10.5px] leading-relaxed italic font-normal">
                        "{rev.depoimento}"
                      </p>
                      <div className="flex items-center justify-between text-[9px] text-gray-400 pt-1 border-t border-gray-100 font-mono">
        ...
        <div className="mt-16 pt-16 border-t border-[#A8CBB1]/30 text-left">
          <div className="mb-8">
            <span className="text-xs font-bold text-[#F28C28] tracking-wider uppercase block mb-1">Evidências visuais demonstrativas</span>
            ...
            <p className="text-[#4B5F55] text-xs sm:text-sm max-w-xl mt-1">
              Ilustrações representativas para demonstrar como o EcoVoz organizaria evidências visuais dos relatos. Em um piloto real, estes cards seriam substituídos por fotos verificadas do território.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {galeriaDeImpactos.map((item) => {
              ...
              return (
                <div 
                  key={item.id}
                  className="bg-white border border-[#A8CBB1]/40 rounded-3xl overflow-hidden flex flex-col justify-between hover:shadow-md hover:border-[#123524]/50 transition-all duration-300 group"
                >
                  <div>
                  ...
                  <div className="p-5 pt-0 border-t border-gray-100/50 mt-2">
                    <button
                      ...
                      className="w-full py-2.5 bg-[#123524] hover:bg-[#2F6B4F] text-white font-extrabold rounded-xl text-xs transition-all flex items-center justify-center space-x-1 shadow-sm hover:shadow-sm cursor-pointer active:scale-95 active:bg-[#123524] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#123524]"
                    >
              ...
              <div className="overflow-y-auto custom-scrollbar flex-grow">
                ...
                <div className="relative h-64 sm:h-72 bg-gray-900">
                  ...
                  <div className="absolute top-5 left-5 text-left">
                    <span className="text-[10px] font-black uppercase bg-[#FFF3E0] text-[#C44A1C] border border-[#F6C56B] px-2.5 py-1 rounded-md inline-block shadow-sm">
                      {selectedGalleryItem.categoria} • Ilustração demonstrativa
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6 md:p-8 space-y-6">
                  <div>
                    <h3 className="font-sans text-2xl font-black tracking-tight text-[#123524]">{selectedGalleryItem.titulo}</h3>
                    <p className="mt-2 text-sm leading-relaxed text-[#4B5F55]">Registro visual demonstrativo para apresentar como evidências territoriais poderiam ser organizadas no EcoVoz.</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-b border-[#DDE8D8] pb-5 text-xs text-[#16231C]">
                    <div className="flex items-center space-x-3 bg-[#F8FAF7] border border-[#DDE8D8] p-3 rounded-xl shadow-sm">
