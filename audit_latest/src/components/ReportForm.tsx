        ...
        <div className="bg-[#f5f7f6] border border-[#e9ecef] rounded-3xl p-6 md:p-10 shadow-lg relative">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white border border-[#e9ecef] rounded-2xl p-4 flex items-start space-x-3 text-left shadow-sm">
              ...
              <div className="grid grid-cols-1 gap-6 text-left">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white border border-[#e9ecef] text-[#0b3d59] focus:outline-[#1b4332] text-sm font-medium cursor-pointer shadow-sm"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white border border-[#e9ecef] text-gray-800 focus:outline-none focus:border-[#1b4332] text-sm transition-colors shadow-sm font-medium"
                  >
                  ...
                  {(['Baixa', 'Média', 'Alta', 'Crítica'] as const).map((g) => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-2 px-3 border rounded-xl text-xs transition-colors shadow-sm ${
              ...
              <div className="space-y-1.5 text-left">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-white border border-[#e9ecef] text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#1b4332] text-sm transition-colors shadow-sm"
                  />
              ...
              {/* LGPD Clause */}
              <div className="bg-[#1b4332]/5 border border-[#1b4332]/10 rounded-2xl p-5 text-left text-xs text-gray-600 space-y-3 shadow-sm">
