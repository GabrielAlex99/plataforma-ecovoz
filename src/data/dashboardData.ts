...
export const limitesPM25MonitorAr: DashboardDataset = {
  ...
  description: 'Apresenta a comparação de material particulado fino em suspensão nos polos vulneráveis monitorados. Dados do protótipo simulado em contraste com o limite regulatório da OMS (5 µg/m³).',
  ...
  data: [
    { name: 'Santa Cruz (RJ)', 'Medição Média': 'A inserir', 'Diretriz OMS': 5 },
    { name: 'Cubatão (SP)', 'Medição Média': 'A inserir', 'Diretriz OMS': 5 },
    { name: 'Volta Redonda (RJ)', 'Medição Média': 'A inserir', 'Diretriz OMS': 5 },
    { name: 'Camaçari (BA)', 'Medição Média': 'A inserir', 'Diretriz OMS': 5 }
  ]
};
