...
export const publicEvidenceCases: RealCase[] = [
  {
    ...
    sourceType: 'official',
    label: 'Dado oficial',
    imageUrl: '/images/gallery-air.png',
  ...
  },
  {
    ...
    sourceType: 'official',
    label: 'Dado oficial',
    imageUrl: '/images/gallery-solution.png',
  ...
  },
  {
    ...
    sourceType: 'official',
    label: 'Dado oficial',
    imageUrl: '/images/gallery-green.png',
...
export const documentedRacismCases: RealCase[] = [
  {
    ...
    title: 'Piquiá de Baixo/MA: poluição industrial e permanência no território',
    ...
    imageUrl: '/images/case-piquia.png',
    imageCaption: 'Imagem representativa de poluição industrial próxima a moradias; consulte a fonte para registros específicos do caso.'
  },
  {
    id: 'case-ilha-mare',
    title: 'Ilha de Maré/BA: pesca, saúde e contaminação no entorno industrial',
    ...
    sourceType: 'documented_case',
    label: 'Caso documentado',
    imageUrl: '/images/case-ilha.png',
    imageCaption: 'Imagem contextual de Ilha de Maré e mariscagem; consulte a fonte para registros específicos do caso.'
  },
  {
    id: 'case-maceio-braskem',
    title: 'Maceió/AL: mineração, deslocamento e perda de território urbano',
    ...
    sourceType: 'documented_case',
    label: 'Caso documentado',
    imageUrl: '/images/case-maceio.png',
    imageCaption: 'Imagem contextual do caso de subsidência urbana em Maceió; consulte a fonte para registros específicos do caso.'
  }
];
