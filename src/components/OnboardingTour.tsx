...
export default function OnboardingTour({ onNavigate, activeSection }: OnboardingTourProps) {
  ...
  const steps: TourStep[] = [
    ...
    },
    {
      ...
      description: "Aqui, todos os relatos socioambientais enviados pela comunidade são consolidados em tempo real no nosso mapa térmico. Isso ajuda a identificar instantaneamente quais vilas e bairros necessitam de auditoria imediata.",
    ...
    },
    {
      ...
      description: "Sua participação é a semente de uma transformação real nas margens industriais. Você pode rever este tour interativo a qualquer momento clicando no ícone flutuante de interrogação no canto do painel.",
      targetId: null,
  ...
  return (
    <div className="fixed inset-0 z-[9999] overflow-x-hidden font-sans pointer-events-auto">
      ...
      >
        <div className="bg-white border border-gray-150 rounded-3xl p-6.5 shadow-2xl text-left relative flex flex-col space-y-4 max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-650 text-xs md:text-sm leading-relaxed font-normal">
