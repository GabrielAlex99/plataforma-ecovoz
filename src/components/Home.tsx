    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <p className="text-[#16231C]/90 text-sm sm:text-base leading-relaxed max-w-xl font-medium">
              A voz da comunidade vira dado. O dado vira ação. Transformamos relatos de moradores em evidências visuais para priorizar respostas, soluções e políticas em territórios vulnerabilizados.
            </p>
          ...
          <div className="lg:col-span-6">
            <div className="bg-white border border-[#A8CBB1] rounded-3xl p-6.5 shadow-md text-left space-y-5">
      ...
      <section className="relative z-10 py-16 md:py-24 bg-white border-t border-[#A8CBB1]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6.5 sm:gap-8">
